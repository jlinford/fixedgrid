...
#define conc_T(row, col) conc_T[NROWS*row + col]
#define wind_T(row, col) wind_T[NROWS*row + col]
#define diff_T(row, col) diff_T[NROWS*row + col]
...
{        
    ...
    /* Transpose buffers */
    volatile real_t conc_T[SPE_MAX_THREADS * NROWS] __attribute__((aligned(128)));
    volatile real_t wind_T[SPE_MAX_THREADS * NROWS] __attribute__((aligned(128)));    
    volatile real_t diff_T[SPE_MAX_THREADS * NROWS] __attribute__((aligned(128)));
