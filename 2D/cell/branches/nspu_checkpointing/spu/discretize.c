...
#define _ADVEC_DIFF_V(c2l, w2l, d2l, c1l, w1l, d1l, c, w, d, c1r, w1r, d1r, c2r, w2r, d2r, out) { \
    ...
    acc1 = (vector value_t)spu_cmpgt(wind, ZERO);   \
    acc1 = spu_and(acc1, advec_term_pos);           \
    acc2 = (vector value_t)spu_cmpgt(ZERO, wind);   \
...
{
    const vector value_t FIVE  = spu_splats(5.0);
    const vector value_t TWO   = spu_splats(2.0);
    const vector value_t ZERO  = spu_splats(0.0);
