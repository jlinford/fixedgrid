...
volatile real_t * C;        /* Concentration of all species */
volatile real_t * VAR;      /* First variable species */
volatile real_t * FIX;      /* First fixed species */
real_t RCONST[NREACT];      /* Rate constants (global) */
real_t ATOL[NVAR];          /* Absolute tolerance */
real_t RTOL[NVAR];          /* Relative tolerance */
real_t TIME;                /* Current integration time */
real_t DT;                  /* Integration step */
real_t SUN;                 /* Sunlight intensity between [0,1] */
real_t TEMP;                /* Temperature */
real_t STEPMIN;             /* Lower bound for integration step */
