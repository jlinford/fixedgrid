...
//#define conc(spec, row, col) conc[row*ROW_LENGTH+col]
 ...
 */
static inline int spe_get_status(fixedgrid_t* G, int id)
{
 ...
 */
static inline void spe_set_status(fixedgrid_t* G, int id, uint32_t status)
{
 ...
 */
static inline void wait_for_spe(fixedgrid_t* G, int id)
{
