...
int main(int argc, char** argv)
{
    ...
    for(iter = 1; iter <= steps; iter++)
    {
        ...
        for(i=0; i<NROWS; i++)
        {
            ...
            spe_argvs[k].arg[0].u64 = (uint64_t)(&conc[(k+i)*NX]);
            spe_argvs[k].arg[1].u64 = (uint64_t)(&wind_u[(k+i)*NX]);
            spe_argvs[k].arg[2].u64 = (uint64_t)(&diff[(k+i)*NX]);
            spe_argvs[k].arg[3].dbl = dt/2;
            spe_argvs[k].arg[4].u32[0] = NX;
            spe_argvs[k].arg[5].dbl = DX;
        ...
        for(i=0; i<NCOLS; i++)
        {
            ...
            spe_argvs[k].arg[4].u32[0] = NY;
            spe_argvs[k].arg[5].dbl = DY;
