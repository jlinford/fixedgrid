...
{        
    ...
    //volatile value_t* conc;
    volatile value_t conc[NROWS * NCOLS * NSPEC] __attribute__((aligned(128)));
    
    /* 2D wind field data: NROWS x NCOLS */
    //volatile value_t* wind_u;
    //volatile value_t* wind_v;
    volatile value_t wind_u[NROWS * NCOLS] __attribute__((aligned(128)));
    volatile value_t wind_v[NROWS * NCOLS] __attribute__((aligned(128)));
    
    /* 2D diffusion tensor data: NROWS x NCOLS */
    //volatile value_t* diff;
    volatile value_t diff[NROWS * NCOLS] __attribute__((aligned(128)));
